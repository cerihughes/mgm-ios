...
import uk.co.cerihughes.denon.core.dao.impl.spotify.SpotifyJsonConverter;
import uk.co.cerihughes.denon.core.dao.rest.ConverterException;
import uk.co.cerihughes.denon.core.model.Track;

public class TestLastFmFavouriteTracksJsonConverter
{
	...
	private LastFmFavouriteTracksJsonConverter cut;

	@Before
	public void setUp()
	{
		cut = new LastFmFavouriteTracksJsonConverter();
	}
