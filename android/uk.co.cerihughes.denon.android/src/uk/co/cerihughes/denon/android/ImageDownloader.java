...
public class ImageDownloader
{
	...
	private void forceDownload(String url, ImageView imageView)
	{
		...
		if (cancelPotentialDownload(url, imageView))
		{
			...
			if (bmp == null)
			{
				final BitmapDrawable d = (BitmapDrawable) res.getDrawable(R.drawable.default_cover);
				bmp = Bitmap.createScaledBitmap(d.getBitmap(), 126, 126, false);
			}
			DownloadedDrawable downloadedDrawable = new DownloadedDrawable(res, task, bmp);
			imageView.setImageDrawable(downloadedDrawable);
			imageView.setMinimumHeight(126);
			task.execute(url);
		}
	}
	...
	static class DownloadedDrawable extends BitmapDrawable
	{
		...
		public DownloadedDrawable(Resources res, BitmapDownloaderTask bitmapDownloaderTask, Bitmap bitmap)
		{
			super(res, bitmap);
