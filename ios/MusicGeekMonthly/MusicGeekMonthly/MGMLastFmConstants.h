...
#define IMAGE_SIZE_NONE @"__none__"
...
#define IMAGE_SIZE_STRINGS @[IMAGE_SIZE_NONE, IMAGE_SIZE_SMALL, IMAGE_SIZE_MEDIUM, IMAGE_SIZE_LARGE, IMAGE_SIZE_EXTRA_LARGE, IMAGE_SIZE_MEGA]
