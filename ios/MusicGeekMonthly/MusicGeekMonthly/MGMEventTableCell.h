...
@property (strong) IBOutlet UIActivityIndicatorView* classicAlbumActivityView;
@property (strong) IBOutlet UIActivityIndicatorView* newlyReleasedAlbumActivityView;
