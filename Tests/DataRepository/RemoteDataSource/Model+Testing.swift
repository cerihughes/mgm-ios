...
extension LocationApiModel {
    static func create(
        ...
        LocationApiModel(name: name, latitude: latitude, longitude: longitude)
    }
}

extension AlbumApiModel {
    static func create(
        type: AlbumApiModel.ModelType,
        spotifyId: String? = nil,
        name: String = "name",
        artist: String = "artist",
        score: Float? = nil,
        images: [ImageApiModel]? = nil
    ) -> AlbumApiModel {
        AlbumApiModel(type: type, spotifyId: spotifyId, name: name, artist: artist, score: score, images: images)
    }
}
...
extension PlaylistApiModel {
    static func create(
        ...
        PlaylistApiModel(spotifyId: spotifyId, name: name, owner: owner, images: images)
    }
}
